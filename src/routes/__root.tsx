  ...
  head: () => ({
    meta: [
      ...
      { title: "Reminder Mail — Penjadwal Email SMTP" },
      {
        name: "description",
        content:
          "Aplikasi pengingat email terjadwal dengan server SMTP sendiri, multi periode tanggal, dan lampiran.",
      },
      { property: "og:title", content: "Reminder Mail — Penjadwal Email SMTP" },
      {
